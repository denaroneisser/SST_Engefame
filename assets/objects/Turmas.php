...
//INCLUIR CÓDIGO DE CONEXÃO COM BANCO DE DADOS
    ...
    $setTurmasSQL = "INSERT INTO Turmas (idTurma,Empresas_idEmpresa,Treinamentos_idTreinamento,Data_Realizacao,Data_Validade,Comprovacao,Modalidade,Carga_Horaria,Preco_Unitario,Curso_Pago) VALUES (?,?,?,?,?,?,?,?,?,?)";
