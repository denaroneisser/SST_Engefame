...
//INCLUIR CÓDIGO DE CONEXÃO COM BANCO DE DADOS
    ...
    $setHistoricoTreinamentoSQL = "INSERT INTO Historico_Treinamentos (Treinamentos_idTreinamento,Funcionarios_CPF,Instrutor,Data_Realizacao,Data_Validade,Comprovacao,Modalidade,Carga_Horaria,curso_pago,Preco_Unitario,Empresas_idEmpresa) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
